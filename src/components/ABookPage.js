...
const ABookPage = props => {
  var urll = null;
  function downloadB() {
    const store = firebase.storage();
    // console.log(store)
    const gsReference = store
      .ref('Books/' + props.item.item.collectionName + '.pdf')
      .getDownloadURL()
      .then(url => {
  ...
  function fetchLike() {
    const searchIndex = props.favorites.findIndex(
      b => b.collectionName == book.collectionName,
    );
    if (searchIndex != -1) {
      // setBId(doc.id);
      setLikeBook(true);
  ...
  function renderBookInfoSection() {
    console.log('AAAAAAAAAAAabook', props.item.item);
      ...
      <View style={{flex: 1}}>
        ...
        <View
          ...
          <Text style={{...FONTS.h2, color: COLORS.white}}>
            {book.collectionName.substr(0, 32)}
             {/*  */}
          </Text>
        ...
        <View
          ...
          <View style={{flex: 1, alignItems: 'center'}}>
            ...
            <Text style={{...FONTS.body4, color: COLORS.white}}>TCount</Text>
          </View>
        ...
        <View
          ...
          {book.primaryGenreName.includes('Mysteries & Thrillers') && (
            <View
              style={{
                justifyContent: 'center',
                alignItems: 'center',
          ...
          {(book.primaryGenreName.includes('Fiction') ||
            book.primaryGenreName.includes('Fiction & Literature')) && (
            <View
              style={{
                justifyContent: 'center',
                alignItems: 'center',
          ...
          {(book.primaryGenreName.includes('Kids') ||
            book.primaryGenreName.includes('Young Adult')) && (
            <View
              style={{
                justifyContent: 'center',
                alignItems: 'center',
          ...
          {book.primaryGenreName.includes('Fantasy') && (
            <View
              style={{
                justifyContent: 'center',
                alignItems: 'center',
          ...
          {book.primaryGenreName.includes('Historical') && (
            <View
              style={{
                justifyContent: 'center',
                alignItems: 'center',
          ...
          {book.primaryGenreName.includes('Personal Finance') && (
            <View
              style={{
                justifyContent: 'center',
                alignItems: 'center',
